...
class SimClrINat21Provider(DatasetProvider):
    ...
    def get_datasets(self, load_train:bool, load_test:bool,
        ...
        if load_train:
            trainpath = os.path.join(self._dataroot, 'inat21', 'train')
            trainset = torchvision.datasets.ImageFolder(trainpath, transform=transform_train)
        if load_test:
            testpath = os.path.join(self._dataroot, 'inat21', 'val')
...
register_dataset_provider('inat21_simclr', SimClrINat21Provider)