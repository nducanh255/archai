...
class Dogs120Provider(DatasetProvider):
    ...
    def get_datasets(self, load_train:bool, load_test:bool,
        ...
        if load_train:
            trainpath = os.path.join(self._dataroot, 'dogs120', 'train')
            trainset = torchvision.datasets.ImageFolder(trainpath, transform=transform_train)
        if load_test:
            testpath = os.path.join(self._dataroot, 'dogs120', 'test')
...
register_dataset_provider('dogs120', Dogs120Provider)