...
class SimClrINat21MiniProvider(DatasetProvider):
    ...
    def get_datasets(self, load_train:bool, load_test:bool,
        ...
        if load_train:
            trainpath = os.path.join(self._dataroot, 'inat21mini', 'train')
            trainset = torchvision.datasets.ImageFolder(trainpath, transform=transform_train)
        if load_test:
            testpath = os.path.join(self._dataroot, 'inat21mini', 'val')
...
register_dataset_provider('inat21mini_simclr', SimClrINat21MiniProvider)