...
from archai.nas.model_desc import ConvMacroParams, CellDesc, CellType, OpDesc, \
                                  EdgeDesc, TensorShape, TensorShapes, NodeDesc, TensorShapesList
from archai.algos.darts.mixed_op import MixedOp
from archai.common.config import Config

class DartsModelDescBuilderSimClr(ModelDescBuilder):
    @overrides
    ...
    def build_logits_op(self, in_shapes:TensorShapesList, conf_model_desc:Config)->OpDesc:
        ...
        return OpDesc('identity',
                        params={'stride':1,
                                'conv': ConvMacroParams(self.get_ch(last_shape),
